...
void Loading()
{
    ...
    tft.drawSmoothCircle(86, 300, 15, WHITE, WHITE);
    delay(1000)
        tft.drawSmoothCircle(172, 300, 15, WHITE, WHITE);
    delay(1000)
        tft.drawSmoothCircle(258, 300, 15, WHITE, WHITE);
    delay(1000)
        tft.drawSmoothCircle(344, 300, 15, WHITE, WHITE);
    delay(1000)
        tft.drawSmoothCircle(430, 300, 15, WHITE, WHITE);
    delay(1000)
