...
#include "SpongeBoB_Painting30pt7b.h"
...
#include <NoDelay.h>
#include "Spongebobtitle_Regular20pt7b.h"
...
void setup()
{
    ...
    Joystickstate = digitalRead(JOYSTICK_BUTTON_PIN);
}
////////////////////////============================================//////////////////////
void fontloading()
{
    tft.setFreeFont(&SpongeBoB_Painting30pt7b);
...
void fontgamebord()
{
    ...
    tft.drawString("w", 5, 0);
    tft.drawString("z", 5, 235);
    tft.drawString("x", 401, 0);
    tft.drawString("y", 401, 235);
...
void BLACKwinanimation()
{
    tft.setFreeFont(&Spongebobtitle_Regular20pt7b);
    tft.setTextColor(WHITE);
    tft.drawString("C", 216, 208);
    delay(50);
    tft.fillRect(210, 196, 36, 52, BLACK);
    tft.drawString("D", 216, 208);
    delay(50);
    tft.fillRect(210, 196, 36, 52, BLACK);
    tft.drawString("E", 216, 208);
    delay(50);
    tft.fillRect(210, 196, 36, 52, BLACK);
    tft.drawString("F", 216, 208);
    delay(50);
    tft.fillRect(210, 196, 36, 52, BLACK);
    tft.setFreeFont(NULL);
}
...
void game()
{
    ...
    for (; digitalRead(JOYSTICK_BUTTON_PIN) == 0;)
    {
